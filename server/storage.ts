...
export class DatabaseStorage implements IStorage {
  ...
  async deleteClassroomEnrolledTeacher(id: string): Promise<void> {
    // First, delete all submissions associated with this teacher
    await db
      .delete(classroomSubmissions)
      .where(eq(classroomSubmissions.teacherId, id));
  ...
  async getClassroomSubmission(id: string): Promise<ClassroomSubmissionWithTeacher | undefined> {
    ...
    return {
      ...
      // Ensure arrays are safe for map() calls
      learningProfile: result.classroom_submissions.learningProfile || [],
      actionsTaken: result.classroom_submissions.actionsTaken || [],
