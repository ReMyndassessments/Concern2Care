      ...
      <CardContent className="px-4 sm:px-6 pt-6">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className={`space-y-6 sm:space-y-8 ${isAtLimit ? 'opacity-60' : ''}`}>
            ...
            {/* Student Differentiation Needs - Only for differentiation tasks */}
            {form.watch('taskType') === 'differentiation' && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 sm:p-6">
                ...
                <p className="text-sm text-amber-700 mb-4">
                  ...
                  Optional: Add details about the student's learning needs for more personalized differentiation strategies
                </p>
